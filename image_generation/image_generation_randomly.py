...
def randomize_configs():
    ...
    colormode = np.random.choice(a=["rgb", "hsl", "hsv"], size=1)[0]
...
if __name__ == '__main__':
    ...
    '''generation 10 different model image--------------------------------------------------
    '''
    n_images = 100
    ...
    for i in range(n_images):
        ...
        generate_image(img_height, img_width, n_depth, n_size, activation, colormode, alpha, z1, z2,
                       show=False, nnet_dict=None, fname=fname, save=True)
        delta = time.time() - start_time
        print("Generating image {} took {} seconds".format(i+1, delta))

    '''generation colormode "hsl" image--------------------------------------------------
    '''
    # img_height = img_width = 512
    # colormode = "hsl"
    # alpha = False
    ...
    '''generation colormode "hsv" image--------------------------------------------------
    '''
