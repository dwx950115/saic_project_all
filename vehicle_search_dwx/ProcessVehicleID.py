...
def fetch_from_vechicle(ID2imgs_path, root, img):
    ...
    with open(ID2imgs_path, 'rb') as f_h:
        ...
        img_root = root + '/image'
        dst_root = '/home/neousys/RepNet_dataset/VehicleID_Part'
...
if __name__ == '__main__':
    # process_vehicleID(root='/home/neousys/duweixin/scia_project/vehicle_search_dwx')
    # split(data_root='/home/neousys/duweixin/scia_project/vehicle_search_dwx/VehicleID_Part')

    process2model_color(root='/home/neousys/duweixin/scia_project/vehicle_search_dwx')
    split2MC(root='/home/neousys/duweixin/scia_project/vehicle_search_dwx',
             TH=0.05)

    form_cls_name(root='/home/neousys/duweixin/scia_project/vehicle_search_dwx')
